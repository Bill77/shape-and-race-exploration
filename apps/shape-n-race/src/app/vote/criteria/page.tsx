...
export default function DataEntryPage() {
  ...
  return (
    <div className="container mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold mb-8">Define the Voting Criteria</h1>
      ...
      <form onSubmit={handleSubmit} className="bg-brand-light rounded-lg shadow-lg p-6">
        ...
        <button
          type="submit"
          disabled={submitting}
          className="w-full bg-teal-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-teal-700 disabled:bg-gray-400 disabled:cursor-not-allowed"
        >
